 ...
 */
public class PostAssignAttendanceImgWSTask extends AsyncTask<Void, Void, PostAttendanceImgWSResult> {
    ...
    public PostAssignAttendanceImgWSTask(Context context, long attendanceImgId, IResultListener listener){
        ...
        try{
            ...
            if (wsResult.getStatus() == BaseWSResult.STATUS_SUCCESS
                ...
                resultValue = AttendanceImgWS
                        .postAssignAttendanceImg(ati.getSessionCode(), ati.getAttendance(mContext).getServerId(), imgServerId);
